...
module.exports = __webpack_require__("OOHQ");
...
var home = __webpack_require__("+UT9");

// EXTERNAL MODULE: ./components/Home/HomeModule.js
var HomeModule = __webpack_require__("9skS");
...
// CONCATENATED MODULE: ./components/Home/Rank.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Rank, _Component);

  function Rank(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Rank);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Rank).call(this, props));
    var rank = props.rank;
    _this.state = {
      rankData: rank
    };
  ...
  Object(createClass["a" /* default */])(Rank, [{
    ...
    key: "render",
    value: function render() {
      var rankData = this.state.rankData;
      return external_react_default.a.createElement(HomeModule["a" /* default */], {
        id: 'rank',
        nav: 'rank'
      }, rankData.length ? external_react_default.a.createElement("ul", {
        className: "list"
      }, rankData.map(function (rank) {
        ...
        }, external_react_default.a.createElement("a", null, external_react_default.a.createElement(Img["a" /* default */], {
          url: rank.coverImgUrl,
          size: 200
        }), external_react_default.a.createElement("p", null, rank.name), external_react_default.a.createElement("i", {
          className: "iconfont icon-right"
        }))));
      })) : external_react_default.a.createElement(Loading["a" /* default */], {
        full: true
      }));
    }
  }], [{
...
var Rank_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchRank: function fetchRank() {
      dispatch(Object(home["m" /* fetchRank */])());
    }
  };
};

/* harmony default export */ var Home_Rank = (Object(external_react_redux_["connect"])(mapStateToProps, Rank_mapDispatchToProps)(Rank_Rank));
// CONCATENATED MODULE: ./pages/home/rank.js





Home_Rank.getInitialProps =
/*#__PURE__*/
function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (store.getState().home.rank.ranks.length === 0) {
              store.dispatch(Object(home["m" /* fetchRank */])());
            }
...
/* harmony default export */ var home_rank = __webpack_exports__["default"] = (Home_Rank);
