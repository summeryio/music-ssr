...
module.exports = __webpack_require__("Hxec");
...
// CONCATENATED MODULE: ./components/Home/Newsong.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Newsong, _Component);

  function Newsong(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Newsong);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Newsong).call(this, props));
    var newsong = props.newsong;
    _this.state = {
      newsongData: newsong
    };
    return _this;
  ...
  Object(createClass["a" /* default */])(Newsong, [{
    ...
    key: "render",
    value: function render() {
      var newsongData = this.state.newsongData;
      return external_react_default.a.createElement(HomeModule["a" /* default */], {
        id: 'new_song',
        nav: 'song'
      }, external_react_default.a.createElement(SongList["a" /* default */], {
        songs: newsongData
      }));
    }
  }], [{
...
var Newsong_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchNewsong: function fetchNewsong() {
      dispatch(Object(home["j" /* fetchNewsong */])());
    }
  };
};

/* harmony default export */ var Home_Newsong = (Object(external_react_redux_["connect"])(mapStateToProps, Newsong_mapDispatchToProps)(Newsong_Newsong));
// CONCATENATED MODULE: ./pages/home/newsong.js





Home_Newsong.getInitialProps =
/*#__PURE__*/
function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (store.getState().home.newsong.newsongs.length === 0) {
              store.dispatch(Object(home["j" /* fetchNewsong */])());
            }
...
/* harmony default export */ var home_newsong = __webpack_exports__["default"] = (Home_Newsong);
