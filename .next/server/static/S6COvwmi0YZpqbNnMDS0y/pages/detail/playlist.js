...
module.exports = __webpack_require__("xxNH");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PullLoadData; });
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0iUn");
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("sLSF");
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("MI3g");
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("a7VT");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _Loading__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("VFWX");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(PullLoadData, _Component);

  function PullLoadData(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, PullLoadData);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(PullLoadData).call(this, props));
    _this.state = {
      page: 0,
      isFoot: true,
      len: 0
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(PullLoadData, [{
    key: "touchStart",
    //接触屏幕
    ...
    value: function render() {
      ...
      }, "\u4E0A\u62C9\u52A0\u8F7D\u66F4\u591A") : react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_Loading__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], null) : react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("p", {
        className: "scroll-tip"
      }, "\u6211\u662F\u6709\u5E95\u7EBF\u7684"));
    }
  }], [{
...
// EXTERNAL MODULE: ./components/PullLoadData.js
var PullLoadData = __webpack_require__("70ZN");
...
function (_Component) {
  ...
  function Comment() {
    ...
    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Comment).apply(this, arguments));
  }
  ...
  Object(createClass["a" /* default */])(Comment, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        id: "comment"
      }, keys_default()(data).length ? external_react_default.a.createElement(external_react_["Fragment"], null, data.hotComments.length ? external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("h6", {
        className: "t"
      }, "\u7CBE\u5F69\u8BC4\u8BBA"), external_react_default.a.createElement("ul", null, data.hotComments.map(function (comment) {
        return external_react_default.a.createElement("li", {
          ...
          href: "/",
          className: "name"
        }, comment.user.nickname), external_react_default.a.createElement("p", {
          className: "time"
        }, Object(util["a" /* formatDateYMD */])(comment.time)), external_react_default.a.createElement("p", {
          className: "like"
        }, external_react_default.a.createElement("span", null, comment.likedCount), external_react_default.a.createElement("i", {
          className: "iconfont icon-like"
        }))), keys_default()(comment.beReplied).length ? external_react_default.a.createElement("div", {
          className: "replied"
        }, external_react_default.a.createElement("p", {
          className: "self"
        }, "\u56DE\u590D", external_react_default.a.createElement("a", {
          href: "/"
        }, "@", comment.beReplied[0].user.nickname), "\uFF1A", comment.content), comment.beReplied[0].content ? external_react_default.a.createElement("p", {
          className: "to"
        }, "@", comment.beReplied[0].user.nickname, "\uFF1A", comment.beReplied[0].content) : external_react_default.a.createElement("p", {
          className: "to"
        }, "\u8BE5\u8BC4\u8BBA\u5DF2\u5220\u9664")) : external_react_default.a.createElement("p", {
          className: "cont"
        }, comment.content)));
      }))) : null, data.comments.length && external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement("h6", {
        className: "t"
      }, "\u6700\u65B0\u8BC4\u8BBA"), external_react_default.a.createElement("ul", null, data.comments.map(function (comment) {
        return external_react_default.a.createElement("li", {
          key: comment.commentId
        }, external_react_default.a.createElement("div", {
          className: "pic"
...
// CONCATENATED MODULE: ./components/Detail/Playlist.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Playlist, _Component);

  function Playlist(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Playlist);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Playlist).call(this, props));
    _this.state = {
  ...
  Object(createClass["a" /* default */])(Playlist, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var query = this.props.router.query;

      if (this.props.isServer) {
        Object(detail["d" /* fetchDetailPlaylist */])(query.id);

        Object(detail["e" /* fetchDetailPlaylistComment */])(query.id, 0);
      }
    }
  }, {
    key: "render",
    value: function render() {
      var _this$state = this.state,
          ...
          commentData = _this$state.commentData;
      var creator = playlistData.creator || {};
      var playCount = playlistData.playCount > 100000 ? parse_int_default()(playlistData.playCount / 10000) + '万' : parse_int_default()(playlistData.playCount);
      return external_react_default.a.createElement("div", {
        id: "playlist_detail"
      ...
      }), external_react_default.a.createElement("em", null, playCount || null)), external_react_default.a.createElement("i", {
        className: "icon-cat"
      }, "\u6B4C\u5355")), external_react_default.a.createElement("div", {
        className: "info"
      }, external_react_default.a.createElement("p", {
        className: "t"
      }, playlistData.name), external_react_default.a.createElement("div", {
        className: "u-img"
      }, external_react_default.a.createElement(Img["a" /* default */], {
        url: creator.avatarUrl,
        size: 60
      }), creator.nickname)))), external_react_default.a.createElement(SongList["a" /* default */], {
        songs: playlistData.tracks
      }), external_react_default.a.createElement(components_Comment, {
        data: commentData
      }));
    }
  }], [{
...
var Playlist_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchDetailPlaylist: function fetchDetailPlaylist(id) {
      dispatch(Object(detail["d" /* fetchDetailPlaylist */])(id));
    },
    fetchDetailPlaylistComment: function fetchDetailPlaylistComment(id, page) {
      dispatch(Object(detail["e" /* fetchDetailPlaylistComment */])(id, page));
    }
  };
};

/* harmony default export */ var Detail_Playlist = (Object(external_react_redux_["connect"])(mapStateToProps, Playlist_mapDispatchToProps)(Object(router_["withRouter"])(Playlist_Playlist)));
// CONCATENATED MODULE: ./pages/detail/playlist.js





Detail_Playlist.getInitialProps =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            store.dispatch(Object(detail["d" /* fetchDetailPlaylist */])(query.id));
            store.getState().detail.comment.comments = {};
            store.dispatch(Object(detail["e" /* fetchDetailPlaylistComment */])(query.id, 0));
...
/* harmony default export */ var playlist = __webpack_exports__["default"] = (Detail_Playlist);
